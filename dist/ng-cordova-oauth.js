...
(function() {
  ...
  function cordovaOauth(
    ...
    $ngCordovaDribble, $ngCordovaPocket, $ngCordovaMercadolibre, $ngCordovaXing, $ngCordovaNetatmo, $ngCordovaTraktTv, $ngCordovaYahoo, $ngCordovaXero) {
...
console.log('Signature: ', signatureObj);
                                        ...
                                        $http({
                                            method: "get",
                                            url: "https://api.xero.com/oauth/AccessToken?oauth_consumer_key=" + clientId + "&oauth_nonce=" + oauthObject.oauth_nonce + "&oauth_signature_method=HMAC-SHA1&oauth_timestamp=" + oauthObject.oauth_timestamp + "&oauth_version=1.0&oauth_token=" + oauthObject.oauth_token + "&oauth_signature=" + signatureObj.signature
