    ...
    function oauthGoogle(clientId, appScope, options) {
      ...
      if(window.cordova) {
        if($cordovaOauthUtility.isInAppBrowserInstalled()) {
          ...
          var browserRef = window.cordova.InAppBrowser.open('https://accounts.google.com/o/oauth2/auth?client_id=' + clientId + '&redirect_uri=' + redirect_uri + '&scope=' + appScope.join("+") + '&include_profile=true&approval_prompt=force&response_type=token id_token', '_blank', 'location=no,clearsessioncache=yes,clearcache=yes');
